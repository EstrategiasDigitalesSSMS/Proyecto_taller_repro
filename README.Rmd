...
Proyecto_taller_repro <img src="figures/readme/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
=========================================================
...
Launch the [`make.R`](https://github.com/EstrategiasDigitalesSSMS/Proyecto_taller_repro/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/EstrategiasDigitalesSSMS/Proyecto_taller_repro/blob/main/CONTRIBUTING.md).
